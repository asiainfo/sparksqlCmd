...
object Conf extends Logging{
  ...
  case class SQLDefinition(name:String, sql: String, outputPath: String, alias: String, dateFormat: String, timeFormat: String, handlerClass: String, groupId: String, operator: String, outputSeparator: String)
